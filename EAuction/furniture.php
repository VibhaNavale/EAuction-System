...
<body style="background-image: url(img/bluebg.png); background-size: cover; background-repeat: no-repeat;">
    ...
    <div class="container">
        ...
        <div class="page-header">
            <h1 style="font-family: papyrus; color: #009688"><b>Furniture category</b></h1>
        </div>
...
$query = "SELECT * FROM products WHERE category='furniture' ORDER BY pid DESC";
...
while($row = $stmt->fetch(PDO::FETCH_ASSOC)){
    ...
    echo "<tr>";
        echo "<td><img style='height: 150px; width:150px;' src='uploads/$image'/></td>";
        echo "<td>{$pname}</td>";
        echo "<td>{$category}</td>";
        ...
        echo "<td>";
            // read one record 
            echo "<a href='furniture_read_one.php?pid={$pid}&user={$uname}' class='btn btn-info m-r-1em'>Read</a>";
...
// paginate records
$page_url="furniture.php?user=$uname&";
