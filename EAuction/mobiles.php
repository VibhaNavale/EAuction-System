...
<body style="background-image: url(img/bluebg.png); background-size: cover; background-repeat: no-repeat;">
    ...
    <div class="container">
        ...
        <div class="page-header">
            <h1 style="font-family: papyrus; color: #009688"><b>Mobile Phones category</b></h1>
        </div>
...
$query = "SELECT * FROM products WHERE category='mobiles' ORDER BY pid DESC";
...
while($row = $stmt->fetch(PDO::FETCH_ASSOC)){
    ...
    echo "<tr>";
        ...
        echo "<td>";
            // read one record 
            echo "<a href='mobiles_read_one.php?pid={$pid}&user={$uname}' class='btn btn-info m-r-1em'>Read</a>";
...
// paginate records
$page_url="mobiles.php?user=$uname&";
