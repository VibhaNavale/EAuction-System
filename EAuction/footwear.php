...
<body style="background-image: url(img/bluebg.png); background-size: cover; background-repeat: no-repeat;">
    ...
    <div class="container">
        ...
        <div class="page-header">
            <h1 style="font-family: papyrus; color: #009688"><b>Footwear category</b></h1>
        </div>
...
$query = "SELECT * FROM products WHERE category='footwear' ORDER BY pid DESC";
...
while($row = $stmt->fetch(PDO::FETCH_ASSOC)){
    ...
    echo "<tr>";
        ...
        echo "<td>";
            // read one record 
            echo "<a href='footwear_read_one.php?pid={$pid}&user={$uname}' class='btn btn-info m-r-1em'>Read</a>";
...
// paginate records
$page_url="footwear.php?user=$uname&";
