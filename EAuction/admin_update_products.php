...
<form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"] . "?pid={$pid}&user={$uname}");?>" method="post">
    <table class='table table-hover table-responsive table-bordered' style="font-size: 17px;">
        ...
        <tr>
            <td>End Time</td>
            <td><input type=datetime-local name='endtime' required="required" value="<?php echo htmlspecialchars($endtime, ENT_QUOTES);  ?>" class='form-control' style="font-size: 15px;" /></td>
        </tr>
        <tr>
            <td></td>
            <td>
